...
pub const ReasoningPhase = struct {
    ...
    pub fn init(allocator: Allocator, level: ThoughtLevel, inner: usize, outer: usize) Self {
        return Self{
            .phase_id = @as(u64, @bitCast(std.time.milliTimestamp())),
            .level = level,
            ...
            .phase_start_time = std.time.milliTimestamp(),
            .phase_end_time = 0,
    ...
    pub fn finalize(self: *Self) void {
        self.phase_end_time = std.time.milliTimestamp();
    }
    ...
    pub fn getDuration(self: *const Self) i64 {
        ...
        return std.time.milliTimestamp() - self.phase_start_time;
    }
};
...
pub const OrchestratorStatistics = struct {
    ...
    pub fn init() OrchestratorStatistics {
        return OrchestratorStatistics{
            ...
            .orchestration_start_time = std.time.milliTimestamp(),
        };
    }
