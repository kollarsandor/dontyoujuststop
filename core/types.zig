...
pub const Fixed32_32 = packed struct {
    ...
    pub fn fromFloat(f: f64) Fixed32_32 {
        return .{ .value = @intFromFloat(f * 4294967296.0) };
    }
    ...
    pub fn add(a: Fixed32_32, b: Fixed32_32) Fixed32_32 {
        return .{ .value = a.value + b.value };
    }

    pub fn sub(a: Fixed32_32, b: Fixed32_32) Fixed32_32 {
        return .{ .value = a.value - b.value };
    }

    pub fn mul(a: Fixed32_32, b: Fixed32_32) Fixed32_32 {
        return .{ .value = @intCast((@as(i128, a.value) * @as(i128, b.value)) >> 32) };
    }

    pub fn div(a: Fixed32_32, b: Fixed32_32) Fixed32_32 {
        if (b.value == 0) return .{ .value = 0 };
        return .{ .value = @intCast((@as(i128, a.value) << 32) / @as(i128, b.value)) };
    }
};
